...
class CrearCeuntePage extends StatefulWidget {
  const CrearCeuntePage({super.key});

  @override
  State<CrearCeuntePage> createState() => _CrearCeuntePageState();
}
final _formkey = GlobalKey<FormState>();
class _CrearCeuntePageState extends State<CrearCeuntePage> {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const TextFormFild(name: "Nombre de usuario", errorname: "Enter your usuario", hintName: "Moisés LP"),
                      const SizedBox(
                        height: 10,
                      ),
                      ...
                      const TextFormFild(name: "Contraseña", errorname: "Enter your Contraseña", hintName: "**************"),
                      const SizedBox(
                        height: 19,
                      ),
                      Row(
                      ...
                      Padding(
                        ...
                        child: Text("¿Ya tienes cuenta en Domestika?", style: MyStyles.segoeUI400.copyWith(color: MyColors.cFFFFFF,letterSpacing: 0.1)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 263),
                        child: TextButton(onPressed: () {
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const IniciarCeuntePage()));
                        }, child: Text("Iniciar Sesión", style: MyStyles.segoeUI400.copyWith(color: MyColors.c000000,letterSpacing: 0.1))),
                      ),
                    ],
                  ),
                ),
